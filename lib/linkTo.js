...
class LinkTo {
    ...
    initHost () {
        ...
        if (this.appType === 'zetrix') {
            ...
            if (this.testnet) {
                // Use testnet URLs
                this.host = deviceTag === 'android' ? hostParam['androidmyidTestnet'] : hostParam['iosmyidTestnet'];
            } else {
                // Use mainnet URLs (default)
        ...
        } else if (this.appType === 'zetrixwv3') {
            if (this.testnet) {
                this.host = deviceTag === 'android' ? hostParam['androidzetrixwv3Testnet'] : hostParam['ioszetrixwv3Testnet'];
            } else {
                this.host = deviceTag === 'android' ? hostParam['androidzetrixwv3'] : hostParam['ioszetrixwv3'];
            }
        }
    }
